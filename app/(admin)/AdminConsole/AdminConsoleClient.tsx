  ...
  return (
    <div className="flex min-h-screen bg-bg">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-line bg-bg/85 px-6 backdrop-blur-xl lg:px-8">
          <div className="flex items-center gap-2 lg:hidden">
            <button
              ...
              className="grid h-10 w-10 place-items-center rounded-xl border border-line bg-surface text-muted transition hover:border-brand/40 hover:text-ink"
              aria-label={lang === "th" ? "เปิดเมนูแอดมิน" : "Open admin menu"}
        ...
        <div className="sticky top-16 z-20 border-b border-line bg-bg/95 backdrop-blur-xl lg:hidden">
              ...
              return (
                <Link
                  ...
                  className={`flex shrink-0 items-center gap-2 rounded-xl border px-3 py-2 text-[11px] font-black transition ${
                    active
                      ? "border-brand bg-brand text-bg shadow-glow"
          ...
          {mobileMenuOpen && (
            <div className="border-t border-line bg-surface px-3 py-3 shadow-card">
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                <Link href="/dashboard">
                  <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-line bg-bg px-3 py-2.5 text-xs font-bold text-muted">
                ...
                <button
                  onClick={handleLogout}
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-down/30 bg-down/5 px-3 py-2.5 text-xs font-bold text-down"
                >
                  <LogOut className="h-4 w-4" />
                  {lang === "th" ? "ออกจากแผงแอดมิน" : "Log out Admin"}
                </button>
