...
export default function DividendStocksPage() {
  ...
  // Filter top high dividend stocks (dividend yield >= 3.5% or DPS > 1.5)
        ...
        <div className="p-4 border-b border-line flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted leading-none mt-1">
              {lang === "th" ? `อัปเดตเรียลไทม์คัดเฉพาะ 10 บริษัทแรกที่มี Yield สูงสุดในฐานข้อมูล` : "Sorted dynamically by highest annualized dividend yield percentage"}
            </p>
          </div>
        </div>
